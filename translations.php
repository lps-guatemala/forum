...
return array(
    ...
    'Create another link' => 'Crear otro link',
    'BRL - Brazilian Real' => 'BRL - Brazilian Real',
    'Add a new Kanboard task' => 'Agregar una nueva tarea en Kanboard',
    'Subtask not started' => 'Subtarea no iniciada',
    'Subtask currently in progress' => 'Subtarea actualmente en proceso',
    'Subtask completed' => 'Subtarea completa',
    'Subtask added successfully.' => 'Subtarea agregada exitosamente',
    '%d subtasks added successfully.' => '',
    'Enter one subtask by line.' => 'Ingrese una subtarea por cada línea',
    'Predefined Contents' => 'Contenidos predefinidos',
    'Predefined contents' => 'Contenidos predefinidos',
    'Predefined Task Description' => 'Descripción de tarea predefinida',
    'Do you really want to remove this template? "%s"' => '¿Realmente desea remover esta plantilla? « %s »',
    'Add predefined task description' => 'Agregar descripción predefinida de la tarea',
    'Predefined Task Descriptions' => 'Descripciones de Tarea Predefinidas',
    'Template created successfully.' => 'Plantilla creada exitosamente',
    'Unable to create this template.' => 'No fue posible crear esta plantilla',
    'Template updated successfully.' => 'Plantilla actualizada exitosamente',
    'Unable to update this template.' => 'No fue posible actualizar esta plantilla',
    'Template removed successfully.' => 'Plantilla removida exitosamente',
    'Unable to remove this template.' => 'No fue posible remover esta plantilla',
    'Template for the task description' => 'Plantilla para descripción de tareas',
    'The start date is greater than the end date' => 'La fecha de inicio es mayor a la fecha de finalización',
    'Tags must be separated by a comma' => 'Las etiquetas deben de separarse por coma',
    'Only the task title is required' => 'Únicamente el titulo de tarea es requerido',
    'Creator Username' => 'Nombre de usuario creador',
    'Color Name' => 'Nombre de Color',
    'Column Name' => 'Nombre de Columna',
    'Swimlane Name' => 'Nombre de Carril',
    'Time Estimated' => 'Tiempo Estimado',
    'Time Spent' => 'Tiempo Utilizado',
    'External Link' => 'Link Externo',
    'This feature enables the iCal feed, RSS feed and the public board view.' => 'Esta característica activa la alimentación de iCal, RSS y la vista pública del tablero',
    'Stop the timer of all subtasks when moving a task to another column' => 'Detener cronometro de todas las subtareas cuando mueva la tarea a otra columna',
    'Subtask Title' => 'Titulo de subtarea',
    'Add a subtask and activate the timer when moving a task to another column' => 'Agregar una subtarea y activar el cronómetro cuando se mueva una taréa a otra columna',
    'days' => 'días',
    'minutes' => 'minutos',
    'seconds' => 'segundos',
    'Assign automatically a color when preset start date is reached' => 'Asignar automáticamente un color al llegar a la fecha de inicio',
    'Move the task to another column once a predefined start date is reached' => 'Mover la tarea a otra columan al llegar a la fecha de inicio',
    'This task is now linked to the task %s with the relation "%s"' => 'Esta tarea esta enlazada a la tarea « %s » con la relación « %s »',
    'The link with the relation "%s" to the task %s has been removed' => 'El enlace con relación « %s » a la tarea « %s » ha sido removido',
    'Custom Filter:' => 'Filtro Personalizado',
    'Unable to find this group.' => 'No es posible encontrar este grupo.',
    '%s moved the task #%d to the column "%s"' => '« %s » movio la tarea #%d a la columna « %s »',
    '%s moved the task #%d to the position %d in the column "%s"' => '« %s » movio la tarea #%d a la posición %d en la columna « %s »',
    '%s moved the task #%d to the swimlane "%s"' => '« %s » movio la tarea #%d al carril "%s"',
    '%sh spent' => '%sh utilizado',
    '%sh estimated' => '%sh estimado',
    'Select All' => 'Seleccionar Todo',
    'Unselect All' => 'Deseleccionar Todo',
    'Apply action' => 'Aplicar acción',
    'Move selected tasks to another column' => 'Mover las tareas seleccionadas a otra columan',
    'Edit tasks in bulk' => 'Editar tareas en masa',
    'Choose the properties that you would like to change for the selected tasks.' => 'Elija las propiedades que desea cambiar para las tarea seleccionadas',
